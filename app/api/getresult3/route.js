...
export async function GET(req) {
  ...
  const prompt = `Provide a list of the 5 best careers ${country ? "in " + country : ""
    } for an individual with an ${type1} personality type and ${type3 ? " and Gallup Strengths types of " + type3 : ""
    }. For each career, include the following information:
        career_name: A brief title of the career?.
        reason_for_recommendation: Why this career is suitable for someone with these interests${country
      ...
      : ""
        ...
        present_trends: Current trends and opportunities in the field${country ? " in " + country : ""
    }.
        future_prospects: Predictions and potential growth in this career${country ? " in " + country : ""
    }.
