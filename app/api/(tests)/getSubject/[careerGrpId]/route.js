...
export async function GET(req, { params }) {
    ...
    try {
        ...
        .leftJoin(USER_SUBJECT_COMPLETION, and(eq(USER_SUBJECT_COMPLETION.user_id, userId), eq(USER_SUBJECT_COMPLETION.subject_id, SUBJECTS.subject_id))) // New join to USER_SUBJECT_COMPLETION
        .where(
            and(
