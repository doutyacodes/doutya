...
//                 await GenerateTestQuiz(userId, subjectId, subjectName, age, birth_date, className, type1, type2, country); // Call function to generate test quiz
...
import { 
    ...
    USER_CAREER, 
    USER_DETAILS,
    SUBJECT_GENERATION_STATUS // Add this import for test generation status
} from '@/utils/schema';
import { NextResponse } from 'next/server';
import { eq, and, gte, lte, inArray } from 'drizzle-orm';
import { authenticate } from '@/lib/jwtMiddleware';
