...
const steps = [
  {
    ...
    content: (
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        <div className="text-5xl mb-4">🌟</div>
        <h2 className="text-2xl font-bold md:text-white mb-2 text-gray-800 md:text-white">Your Personalized Career Companion</h2>
        <p className="text-gray-600 md:text-gray-300 text-center">
          The Career Guide is your comprehensive platform for professional growth, 
          offering personalized guidance, resources, and support to help you 
          navigate and excel in your chosen career path.
        </p>
        <p className="text-gray-600 md:text-gray-300 text-center mt-2">
          Discover a holistic approach to career development with our integrated tools 
          and supportive community.
        </p>
      </div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="space-y-3">
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">📚</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Educational Milestones</h3>
            </div>
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">💪</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Physical Milestones</h3>
            </div>
            <p className="text-gray-600 md:text-gray-400">
              Track and achieve physical wellness goals that complement your 
              professional development.
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">🧠</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Mental Milestones</h3>
            </div>
            <p className="text-gray-600 md:text-gray-400">
              Focus on personal growth through activities like reading, 
              stress management, and mental resilience building.
      ...
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="space-y-3">
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">📝</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Weekly Tests</h3>
            </div>
            <p className="text-gray-600 md:text-gray-400">
              Targeted tests for each subject related to your selected career. 
              Assess your knowledge, identify strengths, and focus on improvement areas.
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">📊</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Test History</h3>
            </div>
            <p className="text-gray-600 md:text-gray-400">
              Track your progress over time. Review past performance, 
              understand improvement areas, and monitor your learning journey.
    ...
    content: (
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="text-3xl mr-3">📈</span>
            <h3 className="text-lg font-semibold text-gray-800 md:text-white">Monthly Performance Evaluation</h3>
          </div>
          <p className="text-gray-600 md:text-gray-400">
            Receive detailed monthly assessments based on your test scores, 
            completed activities, and overall progress. Understand your 
        ...
        <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="text-3xl mr-3">🎯</span>
            <h3 className="text-lg font-semibold text-gray-800 md:text-white">Career Progress Insights</h3>
          </div>
          <p className="text-gray-600 md:text-gray-400">
            Comprehensive career feedback providing a holistic view of 
            your professional growth, skill development, and potential opportunities.
    ...
    content: (
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="text-3xl mr-3">🏆</span>
            <h3 className="text-lg font-semibold text-gray-800 md:text-white">Activity-Based Learning</h3>
          </div>
          <p className="text-gray-600 md:text-gray-400">
            Complete diverse challenges designed to enhance your skills. 
            Submit your work for verification and earn rewards. Each challenge 
    ...
    content: (
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="text-3xl mr-3">👥</span>
            <h3 className="text-lg font-semibold text-gray-800 md:text-white">Career-Specific Communities</h3>
          </div>
          <p className="text-gray-600 md:text-gray-400">
            Connect with peers in careers you&apos;ve selected. Share achievements, 
            learn from other&apos;s experiences, and build meaningful professional relationships.
        ...
        <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
          <div className="flex items-center mb-2">
            <span className="text-3xl mr-3">🤝</span>
            <h3 className="text-lg font-semibold text-gray-800 md:text-white">Collaborative Growth</h3>
          </div>
          <p className="text-gray-600 md:text-gray-400">
            Engage in discussions, share insights, and support each other&apos;s 
            professional journeys.
      ...
      <div className="flex flex-col items-center space-y-4 text-center h-[500px] md:h-[350px] overflow-y-auto">
        ...
        <div className="space-y-3">
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">🌐</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Comprehensive Career Insights</h3>
              </div>
              <p className="text-gray-600 md:text-gray-400">
              A holistic exploration of your career, offering in-depth analysis, strategic guidance, 
              and actionable intelligence to support your professional journey from exploration 
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center mb-2">
              <span className="text-3xl mr-3">🚀</span>
              <h3 className="text-lg font-semibold text-gray-800 md:text-white">Strategic Career Navigation</h3>
              </div>
              <p className="text-gray-600 md:text-gray-400">
              Empower your professional growth with a dynamic, comprehensive approach to career 
              planning. Discover personalized strategies, resources, and insights tailored to 
...
return (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50 p-4">
    ...
    <div className="bg-white md:bg-gray-900 rounded-xl shadow-xl w-full max-w-4xl overflow-hidden relative">
      {/* Close button */}
      <button 
        onClick={handleClose}
        className="absolute top-4 right-4 text-gray-800 md:text-white hover:text-gray-600 md:hover:text-gray-300 z-10"
      >
        <X size={24} />
      </button>

      {/* Progress bar */}
      <div className="flex justify-between bg-gray-200 md:bg-gray-800 px-6 py-3">
        {steps.map((_, index) => (
          <div 
            key={index} 
            className={`h-1 flex-1 rounded-full mx-1 ${
      ...
      {/* Content */}
      <div className="p-4 md:p-6 lg:p-10">
        <h2 className="text-lg md:text-xl font-bold text-gray-800 md:text-white mb-3 text-center">{steps[currentStep].title}</h2>
        <div className="h-96 md:h-72 overflow-y-auto">
          {steps[currentStep].content}
        </div>
      </div>
      ...
      {/* Navigation buttons */}
      <div className="bg-gray-100 md:bg-gray-800 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center">
          {currentStep > 0 ? (
            <button 
              onClick={handlePrevious}
