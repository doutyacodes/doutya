      ...
      content: (
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 md:text-gray-300 font-semibold text-sm md:text-base">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center space-y-4">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 md:text-white mb-2">Your Career Journey Begins</h2>
          <p className="text-gray-600 md:text-gray-300 text-sm md:text-base">
          ...
          <p className="text-gray-600 md:text-gray-300 text-sm md:text-base mt-2">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-3 md:p-4 rounded-lg text-center">
            <div className="text-3xl md:text-4xl mb-1">🧠</div>
            <h3 className="text-md md:text-lg font-semibold text-gray-800 md:text-white">Personality Assessment</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-3 md:p-4 rounded-lg text-center">
            <div className="text-3xl md:text-4xl mb-1">🔍</div>
            <h3 className="text-md md:text-lg font-semibold text-gray-800 md:text-white">Interest Assessment</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-3 md:p-4 rounded-lg text-center">
            <div className="text-3xl md:text-4xl mb-1">🏢</div>
            <h3 className="text-md md:text-lg font-semibold text-gray-800 md:text-white">Industry Selection</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-3 md:p-4 rounded-lg text-center">
            <div className="text-3xl md:text-4xl mb-1">💼</div>
            <h3 className="text-md md:text-lg font-semibold text-gray-800 md:text-white">Career Suggestions</h3>
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-gray-100 md:bg-gray-800 p-3 md:p-4 rounded-lg text-center">
            ...
            <h3 className="text-md md:text-lg font-semibold text-gray-800 md:text-white">Career Roadmaps</h3>
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50 p-4">
      ...
      <div className="bg-white md:bg-gray-900 rounded-xl shadow-xl w-full max-w-2xl overflow-hidden">
        {/* Progress bar */}
        <div className="flex justify-between bg-gray-200 md:bg-gray-800 px-4 md:px-6 py-2 md:py-3">
          {steps.map((_, index) => (
            <div 
              key={index} 
          ...
          <div className="flex items-center mb-2 md:mb-0 w-full md:w-auto">
            {currentStep > 0 ? (
              <button 
                ...
                className="px-3 py-1 md:px-4 md:py-2 mr-3 bg-gray-300 md:bg-gray-700 text-gray-800 md:text-white rounded-md hover:bg-gray-400 md:hover:bg-gray-600 transition-colors"
              >
                Previous
              </button>
            ) : (
            ...
            {currentStep === steps.length - 1 && (
              <div className="flex items-center">
                ...
                <label 
                  ...
                  className="text-gray-600 md:text-gray-300 text-xs md:text-sm"
                >
                  Don&apos;t show again
                </label>
              </div>
