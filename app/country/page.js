    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
                <h1 className="text-2xl font-bold mb-6 text-center">{t('selectYourCountries')}</h1>
                <form onSubmit={handleSubmit}>

                    <div className="mb-4">
                        <label htmlFor="currentCountry" className="block text-sm font-medium text-gray-700">{t('selectCurrentCountry')}</label>
                        <Select
                    ...
                    <div className="mb-4">
                        <label htmlFor="educationCountry" className="block text-sm font-medium text-gray-700">{t('selectEducationCountry')}</label>
                        <Select
                            options={countryOptions}
