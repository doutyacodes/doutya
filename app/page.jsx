...
const Page = () => {
  ...
  return (
    <main className="relative w-full min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-5 sm:pt-40">
        ...
        <div className="relative z-40 container mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            >
              AI-powered guidance that helps students find the right path,
              reassures parents, and gives schools & colleges a complete Career
              Guidance Cell — without hiring counselors.
            </motion.p>
      ...
      <SectionWrapper className="bg-gradient-to-r from-red-900/20 to-orange-900/20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <StatCard
              number="93%"
              text="Students pick careers without expert guidance"
              delay={0}
            />
            <StatCard
              number="₹2L+"
              text="Average cost of hiring counselors annually"
              delay={0.1}
            />
            <StatCard
              number="70%"
              text="Parents rely on outdated advice"
              delay={0.2}
            />
            <StatCard
              number="5 Years"
              text="Average time wasted on wrong career choices"
              delay={0.3}
            />
          </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your institution with comprehensive career guidance that
              works
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Comprehensive assessment reveals each student's ideal career path with actionable insights.",
              ...
              },
              {
                ...
                description:
                  "Continuous support and handholding to keep students on track throughout their journey.",
                color: "bg-purple-500",
              },
              {
                icon: "✅",
                ...
                description:
                  "Complete insights for administrators without needing additional counseling staff.",
                color: "bg-blue-500",
              },
              {
                icon: "✅",
                ...
                description:
                  "Detailed reports that build parent satisfaction and institutional trust.",
                color: "bg-pink-500",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="bg-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/10 hover:bg-white/10 transition-colors duration-300"
              >
                <div className="flex items-center mb-3 sm:mb-4">
                  <div
                    className={`w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 ${item.color} rounded-full flex items-center justify-center mr-3 sm:mr-4`}
                  >
            ...
            {[
              {
                ...
                title: "Take the Test",
                description:
                  "Students complete our AI-driven comprehensive assessment",
                image:
              ...
              },
              {
                ...
                description:
                  "Receive personalized career roadmap with study/skill strategy",
                image:
              ...
              },
              {
                ...
                title: "Stay on Track",
                description:
                  "Monthly guidance, challenges, and progress updates",
                image:
              ...
              },
              {
                ...
                title: "Get Insights",
                description:
                  "Institutions receive batch-level analytics and parent communication",
                image:
      ...
      <SectionWrapper
        id="for-schools"
        className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            variants={fadeInUp}
      ...
      <SectionWrapper
        id="for-students"
        className="bg-gradient-to-r from-emerald-900/20 to-green-900/20"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            variants={fadeInUp}
            ...
            {[
              {
                ...
                title: "Students",
                description:
                  "Discover careers that fit your strengths & interests with AI-powered precision.",
              },
              {
                emoji: "👨‍👩‍👦",
                title: "Parents",
                description:
                  "Get peace of mind with a clear, structured roadmap for your child's future.",
              },
              {
                emoji: "🧭",
                title: "Practical Strategies",
                description:
                  "Learning style insights, skill gaps, and study tips included in every report.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="bg-white/5 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/10 text-center hover:bg-white/10 transition-colors duration-300"
              >
          ...
          <motion.div variants={fadeInUp} className="text-center">
            <CTAButton href="/login">Take the Career Test ₹499</CTAButton>
          </motion.div>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper className="bg-gradient-to-r from-purple-900/20 to-pink-900/20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 lg:mb-8">
              We Don't Just Tell You What Career Fits.
                ...
                {[
                  {
                    ...
                    description:
                      "Visual, auditory, or kinesthetic - we help you understand how you learn best",
                  },
                  {
                    icon: "📚",
                    title: "Custom Study Strategies",
                    description:
                      "Personalized approaches for exams & skill-building based on your learning type",
                  },
                  {
                    icon: "🎯",
                    title: "Smart Preparation",
                    description:
                      "Helps students prepare smarter, not harder, with targeted guidance",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
      ...
      <SectionWrapper
        id="pricing"
        className="bg-gradient-to-r from-indigo-900/20 to-blue-900/20"
      >
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            variants={fadeInUp}
          ...
          >
            {[
              ...
              },
              {
                type: "Parent",
                quote:
                  "Finally, a clear path for my daughter's future. The detailed report gave us confidence in her choices.",
                name: "Rajesh Kumar",
                role: "Parent",
              },
              {
              ...
              >
                <div className="text-emerald-400 mb-3 sm:mb-4 font-semibold text-sm sm:text-base">
            ...
            {[
              {
                ...
                answer:
                  "Our AI-powered assessment has 98.65% accuracy based on thousands of student outcomes and continuous learning algorithms.",
              },
              {
              ...
              },
              {
                ...
                answer:
                  "Yes, parents receive a detailed, easy-to-understand report with actionable insights and recommendations.",
              },
              {
