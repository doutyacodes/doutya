  ...
  const principles = [
    {
      ...
      description:
        "Only with excellent people can Gong be successful in the long run. We’d rather grow slower than lower the bar for hiring and maintaining exceptional talent. Ideally we are looking for people who are as good if not better than us.",
    },
    {
      id: 2,
      title: "CULTIVATE BELONGING AND DIVERSITY",
      description:
        "Our responsibility transcends hitting our goals and KPIs. We know that Gong—and the world—will be a better place when people from diverse backgrounds, races, genders, cultures, sexual orientations, ages, and experiences thrive. We work hard to ensure that everyone feels they belong at Gong and make the extra effort to bring them in.",
    },
    {
      id: 3,
      title: "EMPOWER YOUR TEAM",
      description:
        "We hire, grow, and nurture great people so they can do great things at Gong. We provide our teams with direction and context, then trust and empower them to make it happen. Part of empowering your team is understanding that we all make mistakes. We see mistakes as opportunities for learning and development.",
    },
    {
      id: 4,
      title: "SHARE. A LOT.",
    ...
    },
    {
      ...
      title: "Go Big",
      description:
        "We set ambitious goals that feel uncomfortable and are hard to achieve. We are aware we may not fully achieve them, but we’d rather strive for great things than take the easy route. We’re willing to take calculated risks to yield those big outcomes and experiment with new ideas so we can make Gong exceptional.",
    },
    {
      id: 8,
      title: "WE ARE ALL TEAM GONG",
      description:
        "We’re all part of the same team—Team Gong. Gong’s long-term success will be determined by collaboration between teams. We won’t get there by narrowly focusing on our own team goals. Instead, we operate as one team to help us win.",
    },
    {
      id: 9,
      title: "MAKE TOUGH CALLS",
      description:
        "As leaders, we’re often required to make uncomfortable decisions that may make us or others around us unhappy. Letting inertia guide us or following the path of least resistance may be easier in the short term, but will not get us to where we need to be. Instead, we act swiftly and decisively, making the best choice for Gong.",
    },
    {
      id: 10,
      title: "NO ROYALTY",
      description:
        "Leadership is about responsibility, not superiority. We all play an important role in Gong’s success. We act humbly and modestly, serving our team members, and building relationships as humans regardless of our titles.",
    },
    {
      id: 11,
