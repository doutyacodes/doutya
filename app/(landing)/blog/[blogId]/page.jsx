...
const BlogPage = () => {
  const blog = {
    ...
    content: `
      As I sit down to reflect on the journey that led to the creation of Xortcut, I am filled with gratitude and excitement for what lies ahead. This journey began with a simple realization: the traditional methods of career guidance were no longer sufficient for the challenges faced by today's youth. 
     ...
     Thus, the concept of Xortcut was born.

      The journey to bring Xortcut to life was anything but easy. It took a dedicated team of passionate individuals, each committed to the vision of transforming career guidance. Shabeer, our lead developer, worked tirelessly, guiding our technical team with a relentless pursuit of excellence. Alongside him, our talented developers—Jino, Avni, Mrunal, Shristi, and Wachan—poured their hearts and souls into this project, often putting in sleepless nights to ensure that every detail was perfect.

      
    Together, we faced numerous challenges, from designing an intuitive user interface to developing advanced AI algorithms that would analyze individual strengths and interests effectively. Each team member brought their unique skills and perspectives, collaborating seamlessly to overcome obstacles and refine our platform. Their hard work and dedication were instrumental in shaping Xortcut into what it is today.

      After months of brainstorming, development, and testing, we launched Xortcut with a simple yet powerful vision: to empower young individuals to take control of their career journeys. Our platform not only provides personalized career recommendations but also creates actionable roadmaps to guide users every step of the way. Through milestone tracking and real-time feedback, we aim to inspire confidence and clarity in their pursuits.

     As we celebrate the launch of Xortcut, I am reminded that this is just the beginning. Our journey is about creating a supportive community that fosters growth, exploration, and achievement. We are committed to continuously improving our platform and adapting to the evolving needs of the next generation.

     To all the young dreamers out there: Xortcut is here for you. We are excited to accompany you on your career journey, illuminating the paths that lead to your dreams. Together, let’s redefine career guidance and make your aspirations a reality.
