...
const page = () => {
  ...
  return (
    <main className="relative w-full bg-[#fbf8ff] min-h-screen">
        <Header />
        <section className="container mx-auto p-3 items-center w-full flex flex-col gap-7">
        ...
        <h1 className="text-center  tracking-tight text-3xl sm:text-4xl md:text-5xl font-bold text-[#3e0075] uppercase w-4/5">
          Achieve your revenue goals with Xortcut
        </h1>
        <p className="text-center font-medium text-sm text-[#9069e7] w-4/5">
          See how Xortcut drives revenue outcomes with a powerful suite of AI
          features.
        </p>
      </section>
      <section className="container mx-auto p-3 w-full space-y-4">
