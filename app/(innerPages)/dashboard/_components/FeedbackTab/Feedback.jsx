    ...
    return (
        <FeatureGuideWrapper featureKey="feedback">
            ...
            <div className='flex justify-between'>
                ...
                <div className={`flex gap-5 ${currentFeedbackview === "initialFeedback" ? "hidden" : ""}`}>
                    <Select 
                        defaultValue={selectedPeriod.year?.toString()} 
                        onValueChange={handleYearChange}
                    >
                        <SelectTrigger className="bg-black text-white px-4 py-2 rounded-lg w-32">
...

            {
                ...
                (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-8 px-4">
                      ...
                      <h2 className="text-2xl font-semibold mb-4 text-white">Monthly Feedback</h2>
                      <p className="text-gray-300 mb-6 max-w-md">
                        {feedbackData.message}
                      </p>
                    </div>
                        ...
                        <>
                            ...
                            <div className="text-center mb-8">
                                <h1 className="text-3xl font-bold text-white mb-2">Monthly Feedback Report</h1>
                                <p className="text-gray-400">Your detailed performance analysis and feedback</p>
                            </div>
                            ...
                            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-300 leading-relaxed">{feedbackData.consolidatedFeedback}</p>
                                </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div 
                                    key={index}
                                    className="bg-gray-800/50 rounded-xl p-6 border border-gray-700 transition-all hover:border-gray-600"
                                >
                                    <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-300">{subject.feedback}</p>
                                    </div>
                                    </div>
                                </div>
                                ))}
                            ...
                            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                                ...
                                <div>
                                    <h2 className="text-xl font-semibold text-white mb-2">Challenge Progress</h2>
                                    <p className="text-gray-300 leading-relaxed">{feedbackData.challengeFeedback}</p>
                                </div>
                                </div>
                            </div>
                            ...
                            {/* <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div 
                                        ...
                                        style={{ 
                                        width: `${(feedback?.reduce((acc, subj) => acc + subj.stars, 0) / (feedback?.length * 8)) * 100}%` 
                                        }}
                                    />
                                    </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div 
                                        ...
                                        style={{ width: '75%' }}  // You can calculate this based on challenge completion rate
                                    />
                                    </div>
