...
import PostsCard from '@/app/(innerPages)/dashboard/_components/(Community)/PostsCard/PostsCard';
import PostCreation from '@/app/(innerPages)/dashboard/_components/(Community)/PostCreation/PostCreation';
