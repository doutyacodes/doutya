        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">{user_profile?.name}</h2>
                <p className="text-gray-600">Personal Development Report</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-gray-500">Assessment Completion</div>
              <div className="text-2xl font-bold text-green-600">{assessment_overview?.assessment_completion}</div>
            </div>
          </div>
